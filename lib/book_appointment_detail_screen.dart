                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            spacing: 12,
                            children: [
                              PhosphorIcon(PhosphorIconsFill.star, size: 20),
                              Text(
                          ...
                          SizedBox(
                            ...
                            child: MasonryGridView.count(
                              ...
                              itemBuilder: (context, index) {
                                return _ChipCustom(date: timeSlots[index]);
                              },
                            ),
                          ),
                        ],
...
class _ChipCustom extends StatelessWidget {
  const _ChipCustom({required this.date});
...
class RightAppBar extends StatelessWidget {
  const RightAppBar({super.key, required this.doctor});
